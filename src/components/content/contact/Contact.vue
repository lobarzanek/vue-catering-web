...
function ValidatePhoneNumber(){
  var phoneformat = /^([+][[0-9]{2})?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{3}$/;
...
<template>
    <div class="contact">
        ...
        <div class="name">
            <span>Imię</span>
            <input type="text" id="inputName" placeholder="Andrzej">
            <div class="email">
                <span>Email</span>
                <input type="text" id="inputEmail" placeholder="example@gmail.com">
                <div class="phone">
                    <span>Numer telefonu</span>
                    <input type="text" id="inputPhone" placeholder="+48-123-123-123">
                    <div class="message">
